...
TAPE_ALPHABET = {
    'A':[0b11110, 0b00101, 0b00101, 0b11110, 0b00000],
    ...
    '0':[0b01110, 0b10001, 0b10001, 0b01110, 0b00000, 0b00000],
    '1':[0b00010, 0b11111, 0b00000],
    '2':[0b10010, 0b11001, 0b10101, 0b10010, 0b00000],
    '3':[0b10101, 0b10101, 0b01010, 0b00000],
    '4':[0b00100, 0b00110, 0b11101, 0b00100, 0b00000],
    '5':[0b10111, 0b10101, 0b10101, 0b11101, 0b00000],
    '6':[0b11111, 0b10101, 0b10101, 0b11101, 0b00000],
    '7':[0b00001, 0b11101, 0b00011, 0b00001, 0b00000],
    '8':[0b01010, 0b10101, 0b10101, 0b01010, 0b00000],
    '9':[0b10111, 0b10101, 0b11111, 0b00000],
    '-':[0b00100, 0b00100, 0b00100, 0b00000],
    '+':[0b00100, 0b01110, 0b00100, 0b00000],
    '?':[0b00010, 0b11001, 0b00101, 0b00010, 0b00000],
...
with open(file_path,'r') as file:
    text = file.read()
print(text)
ser = serial.Serial(port=port_path,baudrate=baudrate, bytesize=5, parity='N', stopbits=1)
